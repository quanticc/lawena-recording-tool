...
public class Branch {
    ...
    public enum Type {
        /**
         * Static branches do not use the updater system. They exist as a repository for a release
         * or a version that will not be updated in the future.
         */
        @SerializedName("static")
        STATIC,
        /**
         * Versioned branches adhere strictly to the updater system and will be auto-updated as soon
         * as Getdown detects a newer version.
         */
        @SerializedName("versioned")
        VERSIONED,
        /**
         * Snapshot branches allow updating manually and also rollbacking to previous versions.
         * Updater class provides a way to retrieve the builds available for a specific snapshot
         * branch.
         */
