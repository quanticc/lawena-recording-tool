...
public class UpdateHelper {
	...
	private void cleanupUnusedFiles() {
		try {
			Map<String, Object> config = ConfigUtil.parseConfig(new File("getdown.txt"), ConfigUtil.createOpts(false));
			String[] toDelete = ConfigUtil.getMultiValue(config, "delete");
			if (toDelete != null) {
