...
public class SimpleCustomSettingsDialog extends CustomSettingsDialog {

    private TextArea textArea;

    public SimpleCustomSettingsDialog(Window owner) {
    ...
    @Override
    public SimpleCustomSettingsDialog withInputData(CustomSettingsData input) {
        textArea.clear();
