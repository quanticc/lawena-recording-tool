...
public abstract class AbstractFXMLView implements ApplicationContextAware {
    ...
    FXMLLoader loadSynchronously(URL resource, ResourceBundle bundle) throws IllegalStateException {
        log.debug("Loading view from: {}", resource);
    ...
    /**
     * In case the view was not initialized yet, the conventional fxml are loaded and the specified presenter / controller is going to be constructed and returned.
     *
    ...
    /**
     * @return the name of the fxml file derived from the FXML view.
     */
    ...
    private ResourceBundle getResourceBundle(String name) {
        try {
            ...
            // fallback to application resource bundle
