...
import com.github.iabarca.lwrt.util.CopyDirVisitor;
import com.github.iabarca.lwrt.util.DeleteDirVisitor;
...
public class FileManager {
    ...
    public FileManager(SettingsManager cfg, OSInterface cl) {
        this.cfg = cfg;
        this.cl = cl;
    }
    
    public FileManager(Profiles profiles) {
        this.profiles = profiles;
        this.cl = profiles.getInterface();
    }
