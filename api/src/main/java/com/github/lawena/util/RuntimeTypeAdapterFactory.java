 ...
 * example, consider these types: <p>
 * <pre>
 * {
 *   &#064;code
 ...
 * this drawing a rectangle or a diamond? <p>
 * <pre>
 * {@code
 *   {
 *     "bottomShape": {
 ...
 * honoring that type information when the JSON is deserialized: <p>
 * <pre>
 * {@code
 *   {
 *     "bottomShape": {
 ...
 * configurable. <p> <h3>Registering Types</h3> Create a {@code RuntimeTypeAdapter} by passing the
 * base type and type field name to the {@link #of} factory method. If you don't supply an explicit
 * type field name, {@code "type"} will be used. <p>
 * <pre>
 * {
 *   &#064;code
 ...
 * }
 * </pre>
 * <p> Next register all of your subtypes. Every subtype must be explicitly registered. This
 * protects your application from injection attacks. If you don't supply an explicit type label, the
 * type's simple name will be used. <p>
 * <pre>
 * {@code
 ...
 * }
 * </pre>
 * <p> Finally, register the type adapter in your application's GSON builder: <p>
 * <pre>
 * {
 *   &#064;code
 ...
 * }
 * </pre>
 * <p> Like {@code GsonBuilder}, this API supports chaining: <p>
 * <pre>
 * {
 *   &#064;code
