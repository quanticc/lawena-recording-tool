		...
		"PlaylistBGPanel"
		{
			...
			"PlayListContainer"
			{
				...
				"CasualEntry"
				{
					...
					"image_name"		"casual/gametype_cp"
					"button_token"		"Open DemoUI"
					"button_command"	"engine demoui"
				...
				"CompetitiveEntry"
				{
					...
					"image_name"		"casual/gametype_cp"
					"button_token"		"Open Console"
					"button_command"	"engine toggleconsole"
					"desc_token"		"  "
				}
				...
				"ServerBrowserEntry"
				{
					...
					"image_name"		"casual/gametype_cp"
					"button_token"		"Reload HUD"
					"button_command"	"engine hud_reloadscheme"
				...
				"TrainingEntry"
				{
					...
					"image_name"		"casual/gametype_cp"
					"button_token"		"View HUD elements"
					"button_command"	"engine sv_cheats 1; vgui_drawtree 1"
					"desc_token"		"To identify broken things."
				}
